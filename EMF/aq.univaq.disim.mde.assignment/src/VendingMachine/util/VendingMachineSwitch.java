...
public class VendingMachineSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case VendingMachinePackage.NAME: {
				Name name = (Name)theEObject;
				T result = caseName(name);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case VendingMachinePackage.LOCATION: {
				Location location = (Location)theEObject;
				T result = caseLocation(location);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case VendingMachinePackage.HAS_OPERATION: {
			...
			case VendingMachinePackage.KEYPAD: {
				Keypad keypad = (Keypad)theEObject;
				T result = caseKeypad(keypad);
				if (result == null) result = caseHasOperation(keypad);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case VendingMachinePackage.PAYMENT_PROCESSOR: {
				PaymentProcessor paymentProcessor = (PaymentProcessor)theEObject;
				T result = casePaymentProcessor(paymentProcessor);
				if (result == null) result = caseHasOperation(paymentProcessor);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case VendingMachinePackage.ITEM_GROUP: {
			...
			case VendingMachinePackage.ITEM_PROCESSOR: {
				ItemProcessor itemProcessor = (ItemProcessor)theEObject;
				T result = caseItemProcessor(itemProcessor);
				if (result == null) result = caseHasOperation(itemProcessor);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case VendingMachinePackage.INVENTORY: {
