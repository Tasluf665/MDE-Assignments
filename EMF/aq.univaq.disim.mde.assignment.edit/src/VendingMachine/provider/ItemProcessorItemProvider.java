...
/**
 * This is the item provider adapter for a {@link VendingMachine.ItemProcessor} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ItemProcessorItemProvider extends HasOperationItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ItemProcessor_state_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ItemProcessor_state_feature", "_UI_ItemProcessor_type"),
				 VendingMachinePackage.Literals.ITEM_PROCESSOR__STATE,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		StateOperations labelValue = ((ItemProcessor)object).getOperations();
