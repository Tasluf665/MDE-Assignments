...
/**
 * This is the item provider adapter for a {@link VendingMachine.Location} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LocationItemProvider 
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addLattitudePropertyDescriptor(object);
	...
	/**
	 * This adds a property descriptor for the Lattitude feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addLattitudePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Location_lattitude_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Location_lattitude_feature", "_UI_Location_type"),
				 VendingMachinePackage.Literals.LOCATION__LATTITUDE,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 VendingMachinePackage.Literals.LOCATION__LONGITUDE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.REAL_VALUE_IMAGE,
	...
	protected void addLocationPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Location_location_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Location_location_feature", "_UI_Location_type"),
				 VendingMachinePackage.Literals.LOCATION__LOCATION,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		...
		return getString("_UI_Location_type") + " " + location.getLattitude();
	}
