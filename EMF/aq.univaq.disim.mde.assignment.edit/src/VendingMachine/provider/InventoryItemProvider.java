...
/**
 * This is the item provider adapter for a {@link VendingMachine.Inventory} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class InventoryItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Inventory_totalCapacity_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Inventory_totalCapacity_feature", "_UI_Inventory_type"),
				 VendingMachinePackage.Literals.INVENTORY__TOTAL_CAPACITY,
				 true,
				 false,
				 false,
	...
	protected void addLastRestockedPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Inventory_lastRestocked_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Inventory_lastRestocked_feature", "_UI_Inventory_type"),
				 VendingMachinePackage.Literals.INVENTORY__LAST_RESTOCKED,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(VendingMachinePackage.Literals.INVENTORY__ITEM_GROUP);
		}
	...
	public String getText(Object object) {
		...
		return getString("_UI_Inventory_type") + " " + inventory.getTotalCapacity();
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(VendingMachinePackage.Literals.INVENTORY__ITEM_GROUP,
				 VendingMachineFactory.eINSTANCE.createItemGroup()));
	}
