...
/**
 * This is the item provider adapter for a {@link VendingMachine.Item} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ItemItemProvider 
	...
	protected void addExpiryPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Item_expiry_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Item_expiry_feature", "_UI_Item_type"),
				 VendingMachinePackage.Literals.ITEM__EXPIRY,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		...
		return getString("_UI_Item_type") + " " + item.getId();
	}
